package com.ruanchao.bottomtablayout.view;
...
import com.ruanchao.bottomtablayout.R;
...
public class BottomTabLayoutView extends LinearLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int i = v.getId();
        if (i == R.id.ll_menu_home_page) {
            mViewPager.setCurrentItem(0);
            selectTab(MenuTab.HOME);
        } else if (i == R.id.ll_menu_nearby) {
            mViewPager.setCurrentItem(1);
            selectTab(MenuTab.NEARBY);
        } else if (i == R.id.ll_menu_discover) {
            mViewPager.setCurrentItem(2);
            selectTab(MenuTab.DISCOVER);
        } else if (i == R.id.ll_menu_mine) {
            mViewPager.setCurrentItem(5);
            selectTab(MenuTab.MINE);
        } else if (i == R.id.ll_menu_order) {
